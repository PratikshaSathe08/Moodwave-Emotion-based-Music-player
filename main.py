...
nav = st.sidebar.radio("", ["Home", "About Moodwave", "Our Team", "Play Moodwave"])
...
if nav == "About Moodwave":
    st.markdown("## _Moodwave - Emotion-based Music Player_")
    st.markdown("""
      As
...
if nav == "Our Team":
    ...
    col1.markdown("### Pratiksha Sathe")
    col1.markdown("_\"Its Time to Roll\"_")
    col2.markdown("### Vaidehi Kulkarni")
    col2.markdown("_\"Its Time to Rock\"_")
    col3.markdown("### Sanika Thorat")
